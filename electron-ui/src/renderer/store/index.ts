...
// ── UI store ────────────────────────────────────
interface UiState {
  sidebarTab: 'history' | 'files' | 'settings' | 'notes' | 'skills' | 'memory' | 'workflows'
  sidebarOpen: boolean
  terminalOpen: boolean
  commandPaletteOpen: boolean
  toasts: ToastItem[]
  setSidebarTab: (tab: 'history' | 'files' | 'settings' | 'notes' | 'skills' | 'memory' | 'workflows') => void
  ...
  activeNavItem: 'chat' | 'history' | 'files' | 'terminal' | 'settings' | 'notes' | 'skills' | 'memory' | 'workflows'
...
export const useUiStore = create<UiState>((set) => ({
  ...
  setActiveNavItem: (item) => set((s) => {
    if (item === 'history' || item === 'files' || item === 'settings' || item === 'notes' || item === 'skills' || item === 'memory' || item === 'workflows') {
