...
import { MAX_MEMORIES, MAX_CONTENT_LENGTH, CATEGORIES, fuzzyScore, suggestCategory } from './memoryConstants'
...
export function useMemoryCrud() {
  ...
  }, [newContent, newCategory, memories, saveMemories, addToast])
  ...
  }, [editingId, editContent, editCategory, memories, saveMemories, addToast])
