  ...
  return (
    <button
      ...
      style={{
        ...
        padding: '2px 6px',
        cursor: 'pointer',
        color: copied ? '#22c55e' : 'rgba(255,255,255,0.38)',
        display: 'flex',
        alignItems: 'center',
        gap: 3,
        fontSize: 9,
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, minWidth: 0 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 700, letterSpacing: '-0.01em', lineHeight: 1.3, color: 'rgba(255,255,255,0.82)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
            {displayTitle}
          </span>
          {/* Node type pill */}
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '10px 10px' }}>
              ...
              {onPromptChange && !presetKey && (
                <button
                  ...
                  style={{
                    ...
                    padding: '2px 8px',
                    cursor: 'pointer',
                    color: isEditingPrompt ? 'rgba(255,255,255,0.95)' : 'rgba(255,255,255,0.38)',
                    display: 'flex',
                    alignItems: 'center',
                    gap: 3,
                    fontSize: 9,
        ...
        <div>
          ...
          <div style={{
            fontSize: 12,
            color: (historyOutput || outputText) ? 'rgba(255,255,255,0.82)' : (status === 'running' ? 'rgba(255,255,255,0.45)' : status === 'error' ? '#f87171' : 'rgba(255,255,255,0.82)'),
            lineHeight: 1.5,
            padding: '7px 9px',
      ...
      <div style={{
        ...
        {durationMs !== undefined && status === 'completed' && (
          <span style={{ color: 'rgba(255,255,255,0.38)', fontWeight: 400, fontVariantNumeric: 'tabular-nums' }}>
