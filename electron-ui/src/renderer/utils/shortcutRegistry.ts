...
export const SHORTCUT_REGISTRY: ShortcutEntry[] = [
  // ===== useAppShortcuts.ts (global, always active) =====
  { keys: 'Ctrl+L', description: 'Focus chat input', owner: 'useAppShortcuts.ts', cheatsheetKey: 'focusChatInput' },
  { keys: 'Ctrl+,', description: 'Open settings', owner: 'useAppShortcuts.ts', cheatsheetKey: 'openSettings' },
  ...
  { keys: 'Ctrl+Shift+N', description: 'Toggle Notes panel', owner: 'useAppShortcuts.ts', cheatsheetKey: 'toggleNotes' },
  { keys: 'Ctrl+Shift+C', description: 'Collapse/expand all messages', owner: 'useAppShortcuts.ts', cheatsheetKey: 'collapseExpandAll' },
  { keys: 'Ctrl+Shift+D', description: 'Cycle theme (System/Dark/Light)', owner: 'useAppShortcuts.ts', cheatsheetKey: 'toggleTheme' },
  { keys: 'Ctrl+Shift+L', description: 'Toggle language (en/zh-CN)', owner: 'useAppShortcuts.ts', cheatsheetKey: 'toggleLanguage' },
  { keys: 'Ctrl+Shift+M', description: 'Cycle model (Sonnet/Opus/Haiku)', owner: 'useAppShortcuts.ts', cheatsheetKey: 'cycleModel' },
  { keys: 'Ctrl+Shift+T', description: 'Pin window on top', owner: 'useAppShortcuts.ts', cheatsheetKey: 'pinWindow' },
  { keys: 'Ctrl+1-9', description: 'Switch sidebar tab', owner: 'useAppShortcuts.ts', cheatsheetKey: 'switchSidebarTab' },
  { keys: '/', description: 'Focus session search (when not in input)', owner: 'useAppShortcuts.ts', cheatsheetKey: 'quickSearch' },
  { keys: 'Ctrl+[', description: 'Previous session', owner: 'useAppShortcuts.ts', cheatsheetKey: 'prevNextSession' },
  { keys: 'Ctrl+]', description: 'Next session', owner: 'useAppShortcuts.ts', cheatsheetKey: 'prevNextSession' },
  ...
  { keys: 'Ctrl+Shift+K', description: 'Compact conversation context', owner: 'useChatPanelShortcuts.ts', cheatsheetKey: 'compactConversation' },
